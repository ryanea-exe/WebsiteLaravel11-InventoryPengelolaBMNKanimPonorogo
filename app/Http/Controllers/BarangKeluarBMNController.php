...
class BarangKeluarBMNController extends Controller
{
    public function index(Request $request)
    {
        $query = PengajuanBMN::with([
            'user',
            'details' => function ($q) {
        ...
        return view('pages.barang-keluar-bmn.index', compact('pengajuans'));
    }

    public function detail($id)
    {
        $pengajuan = PengajuanBMN::with([
            'user',
            'details.barang'
        ])->findOrFail($id);
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('barang-keluar-bmn.index')

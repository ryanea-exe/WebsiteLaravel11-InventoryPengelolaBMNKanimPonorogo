...
@section('page-title', 'Detail Pengajuan BMN Saya')
@section('breadcrumb')
    <p class="text-gray-800 cursor-pointer">
        Detail Pengajuan BMN Saya
    </p>
@endsection
...
<div class="bg-white rounded-lg shadow-sm space-y-4">
        ...
        <table class="w-full text-gray-700 border border-gray-300">
            <thead class="bg-gray-200 border-b border-gray-300">
                <tr>
                    ...
                    <th class="px-4 py-3 text-left text-xs font-semibold uppercase">Jumlah Pengajuan</th>
    ...
    <div class="px-4 py-4 flex justify-end gap-2 border-t border-gray-200">
        <button onclick="window.location='{{ route('pengajuan-bmn.riwayat_user') }}'"

...
<body>
    ...
    <!-- ISI -->
    <p class="paragraf">
        Dalam rangka pelaksanaan tugas pelayanan keimigrasian, bersama ini disampaikan permohonan barang sebagai berikut:
    </p>
    ...
    <table class="data">
        <tr style="background-color: #b0ceff;">
            <th width="5%">No</th>
            <th>Nama Barang</th>
            <th width="25%">Jumlah (Satuan)</th>
        </tr>
        @foreach($pengajuan->details as $i => $detail)
        <tr>
            <td align="center">{{ $i + 1 }}</td>
            <td>{{ $detail->barang->nama_barang }} ({{ $detail->barang->merk_type }})</td>

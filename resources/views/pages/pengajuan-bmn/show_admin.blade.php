...
@section('page-title', 'Detail Pengajuan BMN')
@section('breadcrumb')
    <p class="text-gray-800 cursor-pointer">
        Detail Pengajuan BMN
    </p>
@endsection
...
<div class="bg-white rounded-lg shadow-sm space-y-4">
    ...
    <div class="flex items-center justify-between border-b px-4 py-4">
        <div>
            <h2 class="text-xl font-semibold text-gray-800">
                Detail Pengajuan Barang BMN - {{ $pengajuan->kode_pengajuan }}
            </h2>
        </div>
    ...
    @endif
            ...
            <table class="w-full text-gray-700 border border-gray-300">
                <thead class="bg-gray-200 border-b border-gray-300">
                    <tr>
                        ...
                        <th class="px-4 py-3 text-left text-xs font-semibold uppercase">Merk/Type</th>
        ...
        <div class="px-4 py-4 flex justify-end gap-2 border-t border-gray-200">
            <button type="button" onclick="window.location='{{ route('pengajuan-bmn.riwayat_admin') }}'"
...
<script>
    ...
    function simpanStatus() {
        ...
        fetch(`/pengajuan-bmn/{{ $pengajuan->id }}/update-detail-status`, {
            method: 'POST',
            headers: {

...
@section('page-title', 'Input Riwayat Servis')
@section('breadcrumb')
    ...
    <form action="{{ route('pemeliharaan.input_servis.store') }}" method="POST"
        ...
        <div class="px-4 pb-2">
            ...
            <div class="mb-4">
                ...
                <input type="date" name="tanggal_servis" value="{{ date('Y-m-d') }}" required
...
<script>
    ...
    const formPemeliharaan = document.querySelector("form[action='{{ route('pemeliharaan.input_servis.store') }}']");

...
@section('page-title', 'Barang Persediaan')
@section('breadcrumb')
    ...
    <div class="bg-white rounded-lg shadow-sm p-4">
        ...
        <div class="flex justify-between mb-4">
            <h1 class="text-xl font-bold text-gray-800">
                <i class="fas fa-box mr-3"></i>Daftar Barang Persediaan
            </h1>
            ...
            <div class="flex justify-end gap-2">
                ...
                <button onclick="window.location='{{ route('barang-masuk.index') }}'"
                    class="bg-gray-600 hover:bg-gray-700 text-white px-3 py-1.5 rounded-lg font-normal text-sm">
                    <i class="fas fa-sitemap mr-1"></i> Tambah Barang Masuk
                </button>
                <button onclick="openModal('importBarangModal')"
                    class="bg-green-600 hover:bg-green-700 text-white px-3 py-1.5 rounded-lg text-sm">
                    <i class="fas fa-file-excel mr-1"></i> Import Excel
                </button>
                <button onclick="openModal('addBarangModal')" 
                    class="bg-blue-600 hover:bg-blue-700 text-white px-3 py-1.5 rounded-lg font-normal transition flex items-center text-sm">
                    <i class="fas fa-plus-square mr-1"></i> Tambah Data Barang
                </button>
                <!-- <button
...
<!-- IMPORT BARANG MODAL -->
<div id="importBarangModal" class="modal fixed inset-0 bg-black/50 z-[9999] hidden flex items-center justify-center p-4">
    <div class="modal-box max-w-xl w-full">
        <form action="{{ route('barang.import') }}" method="POST" enctype="multipart/form-data"
            ...
            <div class="px-6 py-4 border-b border-gray-200 flex items-center justify-between flex-shrink-0">
                ...
                <button type="button" onclick="closeModal('importBarangModal')"
            ...
            <div class="px-6 py-4 overflow-y-auto flex-1">
                ...
                <p class="text-xs text-gray-500 mt-2">
                    Format kolom: kode_barang, nama_barang, kategori, jumlah, satuan
                </p>
            </div>
    ...
    <div class="modal-box bg-white rounded-2xl w-full max-w-3xl shadow-lg overflow-hidden">
        ...
        <div class="px-6 py-4">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-4">
                ...
                <div>
                    <p class="text-sm text-gray-500 mb-1">Jenis Aset</p>
                    <p id="detailJenisAset" class="font-medium text-gray-800">-</p>
                </div>
                <div>
...
<script>
    ...
    function openDeleteModal(barangId, kodeBarang) {
        ...
        document.getElementById('deleteBarangForm').action = `/barang/${barangId}`;
    ...
    function setupKodeValidation(config) {
        ...
        input.addEventListener('input', function () {
            ...
            timeout = setTimeout(() => {
                ...
                let url = `{{ route('barang.checkKode') }}?kode_barang=${kode}`;

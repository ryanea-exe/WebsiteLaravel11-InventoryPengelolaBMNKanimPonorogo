...
<body>
    ...
    <h3 align="center">LAPORAN SEMUA TRANSAKSI BARANG BMN</h3>
    <p>
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>{{ \Carbon\Carbon::parse($first->pengajuanBMN->tanggal_proses)->format('d M Y, H:i') }}</td>
                <td>
                ...
                <td>{{ $first->pengajuanBMN->user->name ?? '-' }}</td>
            </tr>
            @empty
            <tr>

...
@section('page-title', 'Riwayat Pengajuan Persediaan Saya')
@section('breadcrumb')
    <p class="text-gray-800 cursor-pointer">
        Riwayat Pengajuan Persediaan Saya
    </p>
@endsection
...
<div class="space-y-4">
    <div class="bg-white rounded-lg shadow-sm p-4">
        <h1 class="text-xl font-bold mb-6 text-gray-800">
            <i class="fas fa-history mr-3"></i>Riwayat Pengajuan Barang Persediaan Saya
        </h1>
                                ...
                                <div class="relative inline-block text-left">
                                    ...
                                    <div id="printMenu-{{ $pengajuan->id }}"
                                        ...
                                        <ul class="py-1 text-sm text-gray-800">
                                            ...
                                            <li>
                                                <a href="{{ route('pengajuan.nodin', $pengajuan->id) }}"
                                                    target="_blank"
                                            ...
                                            <li>
                                                <a href="{{ route('pengajuan.bast', $pengajuan->id) }}"
                                                    target="_blank"
                                                    class="block px-4 py-2 hover:bg-gray-100">
                                                    📄 Tanda Terima
                                                </a>
    ...
    <div class="modal-box bg-white rounded-2xl w-full max-w-4xl shadow-xl max-h-[90vh] flex flex-col">
        ...
        <div class="flex items-center justify-between px-6 py-4 border-b">
            <h3 class="text-lg font-semibold text-gray-800" id="detailPengajuanBarangTitle">
                Detail Pengajuan Barang Persediaan
            </h3>
...
<script>
    ...
    function goToDetailPage() {
        if (currentPengajuanId) {
            window.location.href = `/pengajuan/riwayat_user/${currentPengajuanId}`;
        }
    }

...
@section('title', 'Pengajuan Barang Persediaan')

@section('page-title', 'Pengajuan Barang Persediaan')
@section('breadcrumb')
    <p class="text-gray-800 cursor-pointer">
        Pengajuan Barang Persediaan
    </p>
@endsection
    ...
    <form action="{{ route('pengajuan.store') }}" method="POST"
        ...
        <div class="px-4 py-4 border-b mb-4">
            <h1 class="text-xl font-bold text-gray-800">
                <i class="fas fa-file-signature mr-3"></i>Form Pengajuan Barang Persediaan
            </h1>
        </div>
...
<script>
            ...
            <tr class="${stokHabis ? 'bg-red-50' : 'hover:bg-gray-100'}">
                ...
                <td class="px-4 py-1 text-sm text-gray-700">
                    ${stokHabis ? 
                        ...
                        `<button onclick="selectBarang('${b.id}','${b.nama_barang}','${b.jumlah}')"
    ...
    function selectBarang(id, nama, stok) {

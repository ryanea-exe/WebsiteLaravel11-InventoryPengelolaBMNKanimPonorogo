...
@section('page-title', 'Riwayat Pengajuan Persediaan')
@section('breadcrumb')
    <p class="text-gray-800 cursor-pointer">
        Riwayat Pengajuan Persediaan
    </p>
@endsection
            ...
            <ul class="flex flex-wrap -mb-px text-sm font-medium text-center" id="tabMenu">
                ...
                <li class="mr-1">
                    <button onclick="filterSeksi('all')"
                        class="tab-item inline-block px-3 py-2 border-b-2 border-blue-500 text-blue-600 hover:border-blue-500 hover:text-blue-600"
                        data-seksi="all">
                        Semua Seksi
                    </button>
                </li>
        ...
        <div class="p-4">
            ...
            <div class="flex justify-between mb-4">
                <h1 class="text-xl font-bold text-gray-800">
                    <i class="fas fa-history mr-3"></i>Daftar Riwayat Pengajuan Barang Persediaan
                </h1>
                ...
                <table id="dataTable" class="strip text-gray-700 w-full row-border">
                    <thead class="bg-gray-100 border-b border-gray-200">
                        <tr>
                            ...
                            <th class="px-2 py-3 text-left text-sm font-medium text-gray-500 uppercase">Tanggal Pengajuan</th>
                            <th class="px-2 py-3 text-left text-sm font-medium text-gray-500 uppercase">Kode Pengajuan</th>
                            <th class="px-2 py-3 text-left text-sm font-medium text-gray-500 uppercase">Peminta</th>
                            <th class="px-2 py-3 text-left text-sm font-medium text-gray-500 uppercase">Status</th>
                    ...
                    @foreach($pengajuans as $pengajuan)
                        <tr class="hover:bg-gray-50" data-seksi="{{ $pengajuan->user->seksi_id }}">
                            ...
                            <td class="px-2 py-4 text-sm">{{ \Carbon\Carbon::parse($pengajuan->tanggal_pengajuan)->format('d M Y, H:i') }}</td>
                            <td class="px-2 py-4 text-sm">{{ $pengajuan->kode_pengajuan }}</td>
...
<script>
    ...
    function goToDetailPage() {
        if (currentPengajuanId) {
            window.location.href = `/pengajuan/riwayat_admin/${currentPengajuanId}`;
        }
    }
